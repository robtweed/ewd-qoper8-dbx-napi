/*
 ...
 ----------------------------------------------------------------------------
 | ewd-qoper8-dbx-napi: Integrates Cache, IRIS or YottaDB via mg_dbx-napi   |
 |               with ewd-qpoper8 worker modules                            |
 |                                                                          |
...
module.exports = function(worker, params) {
  ...
  //console.log('ewd-qoper8-dbx-napi/lib/dbx - params = ' + JSON.stringify(params, null, 2));

  var DocumentStore = require('ewd-document-store');
  var qewd_mg_dbx = require('qewd-mg-dbx-napi');
  var options = {
    database: {}
  };
  params = params || {};
